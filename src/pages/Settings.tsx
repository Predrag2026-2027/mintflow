...
const s: Record<string, React.CSSProperties> = {
  ...
  deleteBtn: { fontFamily: 'system-ui,sans-serif', fontSize: '11px', fontWeight: '500', padding: '3px 8px', border: '1px solid rgba(255,91,90,0.4)', borderRadius: '6px', background: 'rgba(255,91,90,0.10)', color: '#FF5B5A', cursor: 'pointer', whiteSpace: 'nowrap' as const, flexShrink: 0 },
}