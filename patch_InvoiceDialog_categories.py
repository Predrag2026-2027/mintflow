#!/usr/bin/env python3
"""
Add inline category creation to InvoiceDialog.
Run from project root: python3 patch_InvoiceDialog_categories.py
"""
import sys, os

path = 'src/components/InvoiceDialog.tsx'
...
src = replace_once(src,
    ...
    "import InlineCategoryAdd"
)

# 2. P&L Category field — add + button and InlineCategoryAdd
src = replace_once(src,
    """                      <div style={s.field}>
    ...
    "InvoiceDialog: P&L Category + button"
)
...
src = replace_once(src,
    ...
    "InvoiceDialog: P&L Sub-category + button"
)
...
src = replace_once(src,
    ...
    "InvoiceDialog: Department + button"
)
...
src = replace_once(src,
    ...
    "InvoiceDialog: Dept Sub-category + button"
)

# 6. Expense description — when it's a select (has expDescs)
src = replace_once(src,
    """                    <div style={s.field}>
    ...
    "InvoiceDialog: Expense description + button"
)
